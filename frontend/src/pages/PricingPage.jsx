          ...
          <div className='col-md-12 col-lg-8'>
            <div className='price-box'>
              <div className='grouped-box'>
                ...
                {plan === 1 ? <span className='arrow-down mx-auto'></span> : ''}
              </div>
              <div className='grouped-box'>
                <button
                  onClick={planSelect2}
                ...
                {plan === 2 ? <span className='arrow-down mx-auto'></span> : ''}
              </div>
              <div className='grouped-box'>
                <button
                  onClick={planSelect3}
                ...
                {plan === 3 ? <span className='arrow-down mx-auto'></span> : ''}
              </div>
              <div className='grouped-box'>
                <button
                  onClick={planSelect4}
                ...
                {plan === 4 ? <span className='arrow-down mx-auto'></span> : ''}
              </div>
            </div>
          </div>
        </div>
